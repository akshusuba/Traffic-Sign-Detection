...
//
//  Created by Akshatha Arunkumar on 7/29/21.
//
...
class ViewController: UIViewController,UINavigationControllerDelegate, UIImagePickerControllerDelegate {
    ...
    let signnames = ["stopsign":"Stop Sign","yieldsign":"Yield Sign","childrencrossingsign":"Children Crossing Sign","noturnsign":"No Turn Sign","speedlimitsign":"Speed Limit Sign"]
    ...
    func processFile(image: Data) {
        ...
        let uploadURL = "https://qj9d854kd0.execute-api.us-east-1.amazonaws.com/Predict/fcb5f76c-dcb9-411d-9a5f-5f61c91c0381"
        ...
        AF.upload(imageB64, to: uploadURL).responseJSON { [self] response in
            ...
            switch response.result {
               case .success(let responseJsonStr):
                ...
                let predictionMessage = signnames[predictedValue!]!
